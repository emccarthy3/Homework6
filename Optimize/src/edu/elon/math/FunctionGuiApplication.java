...
public class FunctionGuiApplication extends JFrame implements Observer {
	 ...
	 * @param o
	 */
	public FunctionGuiApplication(Function function) {
	...
	/**
	 * This method gets called when the values of the function have been
	 * modified through setChange() and notifyObservers() methods. It resets the
	 * text-field values based on that change.
	 */
	@Override
	public void update(ArrayList<JTextField> textFields) {
